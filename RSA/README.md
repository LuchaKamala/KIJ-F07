...
## Saran
1. Algoritma RSA lebih baik digunakan pada plaintext yang berukuran kecil, seperti pin atm dan password. <br/>
2. Algoritma RSA lebih baik menggunakan bilangan prima yang besar, karena semakin besar nilai bilangan prima yang ditetapkan, maka semakin kecil kemungkinan dapat ditebak dengan metode cryptoanalytic. <br/>
